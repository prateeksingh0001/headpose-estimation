...
def optimizer_factory(optimizer_config: OptimizerConfig, global_step=tf.Variable) -> Tuple[Optimizer, tf.Tensor]:
  ...
  optimizer_params = {
    "learning_rate": lr_decay if lr_decay is not None else optimizer_config.learning_rate,
