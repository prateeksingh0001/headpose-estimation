...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Head pose estimation using networks fine tuned via transfer learning."
    )
    parser.add_argument(
        "--face_model", dest="face_model", help="Path of the dlib face detection model."
    )
...
def read_images_from_mat(
    mat, input_height=128, input_width=128, input_mean=0, input_std=255
):
