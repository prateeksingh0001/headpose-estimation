...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("-i", "--input-path", type=str, help="Path to the folder containing the images and the ground truth euler angle values")
    parser.add_argument("-o", "--output-path", type=str, help="Path to the directory where the processed dataset will be stored")
    parser.add_argument("-n", "--sub-sample", type=int, default=0, help="Number of examples to subsample from the dataset if set to 0, no subsampling is done")
